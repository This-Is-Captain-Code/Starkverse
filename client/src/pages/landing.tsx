            ...
            {[
              {
                ...
                description: "An immersive EDM concert experience in a cyberpunk metaverse setting",
                date: "Dec 15, 2024",
                participants: "1.2K",
                entryPoints: "500 SP",
                category: "VIP",
              ...
              },
              {
                ...
                description: "Explore cutting-edge NFT art in a virtual gallery space",
                date: "Dec 12, 2024",
                participants: "890",
                entryPoints: "300 SP",
                category: "LIVE",
              ...
              {
                title: "Metaverse Gaming Arena",
                description: "Compete in VR gaming tournaments with crypto prizes", 
                date: "Dec 18, 2024",
                participants: "2.5K",
                entryPoints: "1000 SP",
                category: "TOURNAMENT",
              ...
              <Card key={index} className="bg-gradient-to-br from-dark-surface/50 to-dark-card/30 backdrop-blur-lg border-primary/20 hover:border-primary/50 transition-all duration-300 group">
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${event.categoryColor}`}>
                      {event.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-300">{event.participants}</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Coins className="h-4 w-4 text-accent" />
                      <span className="text-accent font-semibold">{event.entryPoints}</span>
                    </div>
                    <Button 
                      onClick={handleLogin}
                      className="bg-primary hover:bg-primary/80 px-4 py-2 text-sm"
                    >
                      Enter Raffle
                    </Button>
                  </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-dark-surface/30 to-dark-card/20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-secondary mb-2">12.5K</div>
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-green-400 mb-2">8,432</div>
